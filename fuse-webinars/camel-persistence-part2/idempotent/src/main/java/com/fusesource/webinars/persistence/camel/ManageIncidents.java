...
import com.fusesource.webinars.persistence.dao.IncidentDAO;
...
public class ManageIncidents {

        private IncidentDAO incidentDao;

        public Incident getIncident(Exchange exchange) throws ParseException {

        Map<String, Object> model = (Map<String, Object>) exchange.getIn().getBody();
        String key = "com.fusesource.webinars.persistence.model.Incident";
